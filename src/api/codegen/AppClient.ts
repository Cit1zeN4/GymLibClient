...
export class AppClient {
    ...
    public readonly gymLibApiVersion1000CultureNeutralPublicKeyTokenNull: GymLibApiVersion1000CultureNeutralPublicKeyTokenNullService;
    ...
    constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = AxiosHttpRequest) {
        ...
        this.gymLibApiVersion1000CultureNeutralPublicKeyTokenNull = new GymLibApiVersion1000CultureNeutralPublicKeyTokenNullService(this.request);
